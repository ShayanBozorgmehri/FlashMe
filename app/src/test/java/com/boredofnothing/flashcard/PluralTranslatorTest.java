...
public class PluralTranslatorTest {

    @Test
    public void shouldGetPluralTranslationsEndingWithOr(){
    ...
    @Test
    public void shouldGetPluralTranslationsEndingWithEr() {
    ...
    @Test
    public void shouldGetPluralTranslationsEndingWithAr(){
    ...
    @Test
    public void shouldGetPluralTranslationsEndingWithN(){
    ...
    @Test
    public void shouldGetPluralTranslationThatIsSameAsSingular(){
